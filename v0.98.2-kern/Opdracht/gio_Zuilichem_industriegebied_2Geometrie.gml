...
<geo:FeatureCollectionGeometrie xmlns:gml="http://www.opengis.net/gml/3.2"
    ...
    gml:id="main">
    <geo:featureMember>
        <geo:Geometrie gml:id="id-D24C3416-4790-461C-A4D0-A82BA60CA7D6">
            <geo:id>D24C3416-4790-461C-A4D0-A82BA60CA7D6</geo:id>
            <geo:geometrie>
                <gml:MultiSurface srsName="urn:ogc:def:crs:EPSG::28992" gml:id="id-D24C3416-4790-461C-A4D0-A82BA60CA7D6-0">
                    <gml:surfaceMember>
